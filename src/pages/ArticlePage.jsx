  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={content ? content.substring(0, 160) : 'Artículo en Portal de Noticias'} 
        />
        {imageUrl && <meta property="og:image" content={imageUrl} />}
        <meta property="og:title" content={title} />
        <meta property="og:type" content="article" />
        <meta property="article:published_time" content={createdAt?.toDate?.().toISOString()} />
        <meta property="article:section" content={categoryInfo?.name || category} />
      </Helmet>
