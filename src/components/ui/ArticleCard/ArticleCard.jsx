...
const ArticleCard = ({ article, size = "md", featuredTag = false }) => {
  ...
  return (
    ...
    >
      {/* Contenedor de imagen ORIGINAL - Solo añadimos relative aquí */}
      <div
        className={
          is_complementary
      ...
      >
        <ArticleImage
          imageUrl={imageUrl}
          title={title}
          size={is_complementary ? "w-full h-full" : "w-full h-full"} // Mantenemos el tamaño original
        />
        {/* Etiqueta DESTACADO - Solo se muestra si featuredTag es true */}
        {featuredTag && (
      ...
      {/* Este div permanece EXACTAMENTE igual */}
      <div
        className={
          is_complementary
            ? "flex flex-col w-2/3"
